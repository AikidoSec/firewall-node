...
t.test("Check if SQL commands are flagged", async () => {
    t.ok(inputPossibleSql("Roses are red insErts are blue"));
    t.ok(inputPossibleSql("Roses are red cREATES are blue"));
    ...
    t.ok(inputPossibleSql("Roses are red deletes are blue"));
    ...
    t.ok(inputPossibleSql("Roses are red rollbacks are blue"));
    t.ok(inputPossibleSql("Roses are red truncates are blue"));
